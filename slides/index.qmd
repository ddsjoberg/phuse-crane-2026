...
footer: "[www.danieldsjoberg.com/phuse-crane-2026/](https://www.danieldsjoberg.com/phuse-crane-2026/)"
editor: source
engine: knitr
format: 
  revealjs: 
...
df_30day <- 
  cranlogs::cran_downloads(packages = pkgs_all, from = "2026-01-20", to = "2026-02-20") |> 
...
- The {gtsummary} site has recently added an AI assistant and it's AMAZING! (Thanks `kapa.ai`)
...
::::: columns
::: {.column width="50%"}
![](images/crane-movie-poster-musical.png)
:::
...
A "coding partner" that strictly adheres to your domain-specific standards—like tidyverse data prep and crane themes without constant reminders.
...
* **Data Prep:** Use **tidyverse** to finalize factor levels and labels before calling summary functions.

## Table Workflows

### Path A: Data-First (Primary)
Use for standard summaries.
1.  **Function:** `crane::tbl_*()` (if applicable), else `gtsummary::tbl_summary()`.
